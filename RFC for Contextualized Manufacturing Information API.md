...
The SUBSCRIBE interface MUST accept an ElementId as the target of the subscription.

The SUBSCRIBE interface MUST accept the definition of "changed" according to the consumer, including minimum elapsed time, absolute range of change, or relative range of change.

The SUBSCRIBE interface MUST provide changed values according to the filter critera set by the subscriber.
