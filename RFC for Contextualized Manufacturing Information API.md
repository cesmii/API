...
The Subscribe interface SHOULD NOT allow subscription to Type definitions, however the Subscribe interface MAY indicate that a subscribed Element has been impacted by a structural or relationship change that invalidates (or cancels) the subscription. As of this writing, the mechanism for such notification has not been defined.
