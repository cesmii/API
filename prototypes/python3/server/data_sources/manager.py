...
class DataSourceManager(I3XDataSource):
    ...
    def __init__(self, data_sources: Dict[str, I3XDataSource], routing_config: Dict[str, str]):
        """
        ...
        if data_sources:
            ...
            if "primary" in routing_config and routing_config["primary"] in data_sources:
    ...
    def _get_source_for_operation(self, operation: str) -> I3XDataSource:
        ...
        if operation in self.routing_config and self.routing_config[operation] in self.data_sources:
